...
// MAIN COMPONENT
// ============================================
export default function ModernTimeline({ lang }: { lang: Language }) {
    ...
    <>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-1/2 -right-32 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.2, 1],
          ...
          className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-red-500/20 rounded-full blur-3xl"
        />
      </div>
  ...
  return (
    <div className="relative py-20">
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* Main dot */}
              <div
                className="relative w-6 h-6 md:w-8 md:h-8 rounded-full border-3 flex items-center justify-center"
                style={{
      ...
      <div className="absolute -bottom-8 left-0 right-0 flex justify-between px-4">
        <span className="text-xs font-mono text-slate-600">1769</span>
        <span className="text-xs font-mono text-slate-600">2012</span>
        <span className="text-xs font-mono text-slate-600">2030</span>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-10 h-10 rounded-full bg-slate-800/80 hover:bg-slate-700/80 flex items-center justify-center transition-colors border border-white/10"
        >
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {milestone.inventions.map((inv, idx) => (
                  ...
                  >
                    <div className="text-xs text-slate-500 mb-1 font-mono">{inv.year}</div>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3 flex-wrap">
                {milestone.socialImpact.gdp && (
                  <div className="px-4 py-2 rounded-lg" style={{ background: 'rgba(255,255,255,0.03)' }}>
                ...
                {milestone.socialImpact.productivity && (
                  <div className="px-4 py-2 rounded-lg" style={{ background: 'rgba(255,255,255,0.03)' }}>
                    <div className="text-xs text-slate-500">{lang === 'en' ? 'Productivity' : '生产力'}</div>
